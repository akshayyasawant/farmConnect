...
// const Buyer = require('./models/Buyer'); // Adjust the path as needed
...
// // Connect to MongoDB
// mongoose.connect('mongodb://localhost:27017/farmconnectdb', {
//     useNewUrlParser: true,
//     useUnifiedTopology: true,
// })
// .then(() => {
//     console.log('Connected to MongoDB database: farmconnectdb');
// })
// .catch(err => {
...
// Assuming you already have this in your index.js
...
// const bodyParser = require('body-parser');
// const cors = require('cors');
// const buyerRoutes = require('./routes/buyer'); // Make sure this is the correct path
...
//     const token = jwt.sign({ id: buyer._id }, 'your_jwt_secret', { expiresIn: '1h' });
...
//     try {
//       const hashedPassword = await bcrypt.hash(password, 10); // Ensure you are hashing the password
//       const newBuyer = new Buyer({ firstName, lastName, address, phoneNumber, email, password: hashedPassword });
  
//       const savedBuyer = await newBuyer.save(); // Save the buyer to the database
//       res.status(201).json({ success: true, message: 'Buyer registered successfully!', buyer: savedBuyer });
//     } catch (error) {
